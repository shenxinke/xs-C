...
public class JZVideoPlayerStandard extends JZVideoPlayer {
     ...
     * 获取播放状态的接口
     */
    private OneSelfInterface oneSelfInterface;
    ...
    public void onStatePlaying() {
        ...
        if (oneSelfInterface == null) return;
        oneSelfInterface.onVideoPlaying();
    }
...
//                Toast.makeText(getContext(), getResources().getString(R.string.no_url), Toast.LENGTH_SHORT).show();
     ...
     * 设置滑动进度条
     *
     * @param seekBarListener
     */
    public void setSeekBarListener(SeekBar seekBarListener) {
        seekBarListener.setOnSeekBarChangeListener(this);
    }

    /**
     * 设置播放状态回调接口
     *
     * @param oneSelfInterface
     */
    public void setOneSelfInterface(OneSelfInterface oneSelfInterface) {
        this.oneSelfInterface = oneSelfInterface;
    }
