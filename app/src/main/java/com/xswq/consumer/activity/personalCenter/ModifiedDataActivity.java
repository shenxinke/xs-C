 ...
 * 修改资料
 */
public class ModifiedDataActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modified_data_layout);
    ...
    private void getAddress() {
        CityPicker cityPicker = new CityPicker
                .Builder(ModifiedDataActivity.this)
        ...
        try {
            OkHttpUtils.post().url(ContactUrl.POST_UPDATE_USER_IN_PATH)
                ...
                public void onResponse(String response, int id) {
                    BaseBean baseBean = GsonUtil.gsonToBean(response, BaseBean.class, ModifiedDataActivity.this);
                    if (baseBean != null) {
                        finish();
    ...
    private void getUserInfo() {
        try {
            OkHttpUtils.post().url(ContactUrl.POST_USER_IN_PATH)
                ...
                @Override
                public void onResponse(String response, int id) {
                    BasicInformaitonBean sekiguchiBygateNumBean = GsonUtil.gsonToBean(response, BasicInformaitonBean.class, ModifiedDataActivity.this);
    ...
    private void showPopupWindow(View view, final int type) {
        View layout = LayoutInflater.from(ModifiedDataActivity.this).inflate(R.layout.pop_window_layout, null, false);
