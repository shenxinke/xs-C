 ...
 * 更改头像框页面
 */
public class PictureFrameFragment extends BaseFragment implements ViewPager.OnPageChangeListener {
    private View mView;
                ...
                public void onResponse(String response, int id) {
                    ...
                    if (achievementBean != null) {
                        ...
                        if (data.size() > 0) {
                            ...
                            if (lists.size() > 1) mNextBg.setVisibility(View.VISIBLE);
     ...
     * @return
     */
    public List<List<HeadPortraitBean.DataBean>> splitList(List<HeadPortraitBean.DataBean> list, int len) {
